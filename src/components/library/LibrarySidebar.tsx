import { Home, Library, LayoutTemplate, Settings, Crown, CreditCard, ChevronDown, Palette, Paintbrush, SwatchBook, BarChart3, CalendarDays, GalleryHorizontalEnd, Target } from "lucide-react";
