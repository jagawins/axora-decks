      ...
      <div className="container-wide">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/executive" className="text-sm text-muted-foreground hover:text-accent transition-colors">
                  Executive Hub
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/webinars" className="text-sm text-muted-foreground hover:text-accent transition-colors">
                  Webinars
                </Link>
              </li>
              <li>
                <Link to="/all-hands" className="text-sm text-muted-foreground hover:text-accent transition-colors">
                  All-Hands
                </Link>
              </li>
              <li>
        ...
        <div className="flex flex-col items-center gap-4 md:flex-row md:justify-between md:gap-6">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground order-2 md:order-3">
            © {new Date().getFullYear()} AXIVA. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
