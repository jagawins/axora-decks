...
const heroFeatures = [
  ...
  { label: "Webinar-Ready", icon: Calendar },
...
const featureBlocks = [
  ...
  { icon: Shield, title: "Smart Slides (Live Adaptive)", subtitle: "No competitor has this. Slides that adapt during your meeting.", description: "Type audience requirements or use voice recognition during your presentation. Downstream slides regenerate in real-time using AI. The customer says their RPO is 15 minutes, and by slide 6 the architecture has already adapted.", color: "#EF4444", details: ["Live Input: capture requirements during the meeting (text, number, select)", "Voice Input: browser speech recognition extracts key parameters automatically", "Adaptive Blocks: downstream slides detect new data and regenerate with AI", "Variables persist across all slides in the deck via shared context", "Example: customer shares RPO/RTO on slide 3, architecture adapts by slide 6"], cta: { text: "See How It Works", href: "/templates/smart-slides-demo" } },
  { icon: Calendar, title: "Webinar-Ready Platform", subtitle: "One tool replaces PowerPoint + Slido + speaker notes", description: "Stop juggling separate tools. AXIVA generates your deck, writes your speech with delivery coaching, runs live polls with QR codes, and saves results. Before, during, and after your webinar.", color: "#F59E0B", details: ["Before: AI deck generation + speech prep + pre-event Q&A collection", "During: live polls with QR codes + delivery coaching + audience Q&A", "After: poll results saved + unanswered questions exported + outcomes tracked", "AI suggests 3 audience polls based on your speech content", "Replaces PowerPoint + Slido + Google Docs + Excel. One subscription"], cta: { text: "See Webinar Solution", href: "/webinars" } },
