...
const heroFeatures = [
  { label: "Message Architecture", icon: Target },
...
const featureBlocks = [
  { icon: Target, title: "Message Architecture Engine", subtitle: "Enforce decision-first structure on every deck", description: "5-step guided wizard: choose architecture type, define decision, brief the audience, build 3 MECE reasons with evidence, craft the ask. Three modes: Decision Brief, Change Narrative, Crisis Statement.", color: "#3B82F6", details: ["Decision Brief: Answer first → 3 reasons → evidence → ask", "Change Narrative: What is → what could be → contrast loop → invitation", "Crisis Statement: Empathy → facts → next update → action", "MECE contradiction checking on reasons", "AI suggest for decision statements and asks"], cta: { text: "Try Executive Hub", href: "/executive" } },
  ...
  { icon: BarChart3, title: "Outcome Analytics", subtitle: "Track whether communication drove decisions", description: "Clarity scores, objection coverage, decision latency, rehearsal compliance. Presentation history with outcome badges. AI insights on what drives same-day approvals.", color: "#8B5CF6", details: ["Clarity score: audience understanding rating", "Objection coverage: % of anticipated objections addressed", "Decision latency: time from presentation to approval", "Rehearsal compliance: run-throughs completed before delivery", "AI insights: correlation between prep quality and outcomes"], cta: { text: "Try Analytics", href: "/executive" } },
