  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://axor.verityaxis.com/privacy" />
        ...
        <div className="container-wide max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            <p className="text-lg text-muted-foreground">
              AXORA values privacy. This policy explains what we collect, why we collect it, and how we handle it when you use axor.verityaxis.com and related services.
            </p>
