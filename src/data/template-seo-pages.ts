...
export const TEMPLATE_SEO_PAGES: TemplateSEOPage[] = [
  ...
  },
  {
    ...
    description: "Generate consulting-grade presentations using BCG and McKinsey slide methodology. AI-powered action titles, Pyramid Principle structure, data-heavy frameworks, and executive-ready formatting.",
    keywords: ["consulting deck template", "McKinsey slide template", "BCG presentation generator", "consulting presentation AI", "Pyramid Principle slides", "strategy consulting deck"],
    heroSubline: "Generate consulting-grade slide decks with AI — action titles, Pyramid Principle structure, data-driven frameworks, and the visual density McKinsey and BCG clients expect. In under 2 minutes.",
    category: "Strategy",
    tags: ["consulting", "McKinsey", "BCG", "strategy", "Pyramid Principle", "frameworks"],
    useCases: [
    ...
    faqItems: [
      { q: "Does it follow the Pyramid Principle?", a: "Yes. AXIVA's AI is trained on consulting methodology. Every deck starts with the answer (executive summary), then provides supporting evidence. Section headings are action titles — complete assertions, not topic labels." },
      ...
      { q: "How is this different from Gamma or Canva?", a: "Generic AI tools produce topic-label headings and text-heavy slides. AXIVA generates action titles, answer-first structure, and 70%+ visual density — the consulting standard. No other tool enforces the Pyramid Principle by default." },
